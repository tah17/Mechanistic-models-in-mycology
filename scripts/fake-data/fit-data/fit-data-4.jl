...
#  AND A PROPOSED CONVENTIONAL EXPERIMENTAL DESIGN BUT THE EXPERIMENT IS DONE IN IMMUNOCOMPETENT MICE AND NEUTROPHILS (N) ARE RECORDED (fake-data-4.jl)
...
#
# records job IDs  - NOTE need file fit-4-ids.txt already created and in same directory as sub file
#
job_id = #get job id
job_recorded = false
open("fit-4-ids.txt") do io
...
#
# set up fitting specifications and fit ODE
#
if algo == "BH"
